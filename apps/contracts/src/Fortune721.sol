    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory svg = string(
            abi.encodePacked(
                ...
                '<text x="960" y="500" text-anchor="middle" fill="#000" font-size="48" font-family="',
                bytes(fontURI).length > 0 ? "Custom" : "monospace",
                '">',
                text1,
                '</text>',
                '<text x="960" y="640" text-anchor="middle" fill="#000" font-size="48" font-family="',
                bytes(fontURI).length > 0 ? "Custom" : "monospace",
                '">',
                text2,
                '</text>',
                '<text x="960" y="780" text-anchor="middle" fill="#000" font-size="48" font-family="',
                bytes(fontURI).length > 0 ? "Custom" : "monospace",
                '">',
                text3,
                '</text>',
