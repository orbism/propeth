...
interface IPack1155NonUpgradeable {
...
contract Fortune721 is ERC721, ERC2981, Ownable, ReentrancyGuard {
        ...
        returns (uint256 tokenId)
    {
        ...
        if (!IPack1155NonUpgradeable(pack1155).hasMintedPack(msg.sender)) revert UserHasNotMintedPack();

        // Get the cards they were actually minted
        uint256[3] memory expectedCards = IPack1155NonUpgradeable(pack1155).getLastThreeCardsMinted(msg.sender);
